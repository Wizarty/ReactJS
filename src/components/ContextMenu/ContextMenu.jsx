...
const ContextMenu = ({ record, visible, x, y }) => {
    ...
    const { setRecord, setIsModalOpen, setEmployee, setResponse } = useContext(GlobalContext);
    ...
    return visible &&
        <ul className="popup" style={{ left: `${x}px`, top: `${y}px` }}>
            ...
            <li onClick={handleDeleteClick}><Delete className="crud-buttons" color="#800000" /><span className="crud-button-item">წაშლა</span></li>
        </ul>
}
